...
Smart Contract Security course. The PasswordStore protocol was reviewed as part of 
...
We show one such method of reading any data off chain directly
...
```javascript
    function test_anyone_can_set_password(address randomAddress) public {
        ...
        string memory expectedPassword = "THIS_IS_RANDOM_PASSWORD";
        passwordStore.setPassword(expectedPassword);

        vm.prank(owner);
        string memory passwordAfter = passwordStore.getPassword();

        assertEq(passwordAfter, expectedPassword);
    }
```
